    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex flex-col" dir={i18n.language === 'ar' ? 'rtl' : 'ltr'}>
      ...
      <div className="flex flex-1 overflow-hidden pt-16">
        ...
        <div className="hidden md:flex flex-col w-80 border-r border-gray-200 bg-white">
          {/* New Chat Button */}
          <div className="p-4">
            <button onClick={()=>window.location.reload()} className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-3 px-4 rounded-lg font-medium hover:from-blue-700 hover:to-indigo-700 transition-all flex items-center justify-center">
